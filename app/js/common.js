...
$(function() {
	...
	// Scroll Magic
		...
		// Petals
			...
			var prodPetalsTween = new TimelineMax().to('.product-petals .petal', 0.4, {ease: easing, opacity: 1, x: '0%', y: '0%', scale: 1});
		...
		// Products
			...
			.staggerTo('.product__title', 0.8, {ease: easing, opacity: 1, y: '0%'}, 0.2, '-=0.6')
			.staggerFrom('.product__link', 0.6, {ease: easing, opacity: 0, y: '50%'}, 0.2, '-=1.0')
